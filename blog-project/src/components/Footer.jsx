...
const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-gray-800 text-gray-100">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0" bis_skin_checked="1">
        <div className="lg:w-1/3" bis_skin_checked="1">
          <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-violet-400" bis_skin_checked="1">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4" bis_skin_checked="1">
          ...
          <div className="space-y-3" bis_skin_checked="1">
            <div className="uppercase text-gray-50" bis_skin_checked="1">Social media</div>
      ...
      <div className="py-6 text-sm text-center text-gray-400" bis_skin_checked="1">© 1968 Company Co. All rights reserved.</div>
    </footer>
  )
};
